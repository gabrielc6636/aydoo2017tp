...
describe 'Evento' do
  ...
  it 'no es posible crear un evento con fin anterior al inicio' do
    ...
    expect {Evento.new(calendario, "1", "Un evento",
                       "2017-03-31T18:00:00-03:00", "2017-03-31T17:00:00-03:00"
    )}.to raise_error(ExceptionDuracionInvalida)
  end

  it 'no es posible crear un evento de mas de 72 horas' do
    calendario = Calendario.new("Un calendario")
    expect {Evento.new(calendario, "1", "Un evento",
                       "2017-03-28T17:00:00-03:00", "2017-03-31T18:00:00-03:00"
    )}.to raise_error(ExceptionDuracionInvalida)
  end
  ...
  it 'no es posible agregar un evento con id repetido' do
    ...
    Evento.new(calendario, "1", "Un evento", "2017-03-31T18:00:00-03:00",
               "2017-03-31T22:00:00-03:00")
    expect {Evento.new(calendario, "1", "Otro evento",
                       "2017-03-31T18:00:00-03:00", "2017-03-31T22:00:00-03:00"
  ...
  it 'se comprueba la duracion nueva al actualizar un evento' do
    ...
    evento = Evento.new(calendario, "1", "Un evento",
                        "2017-03-31T18:00:00-03:00",
                        "2017-03-31T22:00:00-03:00")
    expect {evento.actualizar("2017-04-30T18:00:00-03:00",
                              "2017-05-31T22:00:00-03:00"
    )}.to raise_error(ExceptionDuracionInvalida)
  end
  ...
  it 'es posible obtener un evento con recurrencia como hash' do
    ...
    evento = Evento.new(calendario, "1", "Un evento",
                        "2017-03-31T18:00:00-03:00",
                        "2017-03-31T22:00:00-03:00", recurrencia)
    recurrencia_hash = {"frecuencia" => "semanal",
                        "fin" => "2017-04-30T22:00:00-03:00"}
    hash = {"calendario" => "Un calendario",
            "id" => "1",
            "nombre" => "Un evento",
